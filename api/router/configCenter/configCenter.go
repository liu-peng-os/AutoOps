...
func RegisterConfigCenterRoutes(router *gin.RouterGroup) {
	...
	ansibleConfigCtrl := controller.NewAnsibleConfigController()
	...
	router.GET("/config/ansible", ansibleConfigCtrl.List)
	router.POST("/config/ansible", ansibleConfigCtrl.Create)
	router.GET("/config/ansible/:id", ansibleConfigCtrl.GetByID)
	router.PUT("/config/ansible/:id", ansibleConfigCtrl.Update)
	router.DELETE("/config/ansible/:id", ansibleConfigCtrl.Delete)
}
